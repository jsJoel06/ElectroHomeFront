        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <select required value={categoriaId} onChange={(e) => setCategoriaId(e.target.value)} title="Seleccionar categoría del producto"
          ...
          <div className="space-y-3">
            ...
            <div className="relative group overflow-hidden border-2 border-dashed border-gray-100 rounded-[3rem] p-12 text-center hover:border-black hover:bg-gray-50 transition-all cursor-pointer">
              <input type="file" className="absolute inset-0 opacity-0 cursor-pointer z-10" title="Seleccionar imagen del producto"
